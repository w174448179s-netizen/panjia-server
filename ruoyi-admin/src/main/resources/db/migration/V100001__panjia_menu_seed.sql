...
-- 注：原 2201「业绩明细」残留已删除（perms=performance:fact:* 后端不存在）。
--     唯一「业绩明细」菜单为 V140003 的 2610（perms=perf:fact:*，与 PerformanceFactController 对齐），
...
(1761300000000000010, 1761400000000002610),  -- 业绩明细（全量；菜单由 V140003 提供）
(1761300000000000010, 1761400000000002611),  -- 业绩明细-查询按钮
...
(1761300000000000011, 1761400000000002610),  -- 业绩明细（本店；菜单由 V140003 提供）
(1761300000000000011, 1761400000000002611),  -- 业绩明细-查询按钮
...
(1761300000000000012, 1761400000000002610),  -- 业绩明细（全量；菜单由 V140003 提供）
(1761300000000000012, 1761400000000002611),  -- 业绩明细-查询按钮
...
(1761300000000000014, 1761400000000002610),  -- 业绩明细（本人；菜单由 V140003 提供）
(1761300000000000014, 1761400000000002611),  -- 业绩明细-查询按钮
